...
;   
  ...
  create or replace task DBT_DEMO.ADMIN_CONFIG.STD_POS_DBT_PROJ
    warehouse=ACCOUNT_ADMIN_WH
	schedule='USING CRON 0 * * * *  Europe/London'
	as EXECUTE dbt project STD_POS_DBT_PROJ args='run --target dev';
    
   GRANT OWNERSHIP ON TASK  DBT_DEMO.ADMIN_CONFIG.STD_POS_DBT_PROJ TO ROLE  SYSADMIN COPY CURRENT GRANTS; 

   ALTER TASK DBT_DEMO.ADMIN_CONFIG.STD_POS_DBT_PROJ RESUME;
